...
<main>
	<div>
		<h1 id="header">
			...
			<p class="description">
				I bridge technical and financial insight to bring scalable machine-vision products to
				market, using data to deeply understand customer needs.
			</p>
		</h1>
		<div class="icons">
			<div
...
<style>
	...
	main {
		...
		min-height: calc(100dvh - 80px - 88px);
		justify-content: center;
		align-items: center;
		padding: 12px clamp(16px, 6vw, 28px) 20px;
	}
	...
	@media (max-width: 600px) {
		...
		main {
			padding: max(14px, env(safe-area-inset-top)) max(18px, env(safe-area-inset-right)) 22px
